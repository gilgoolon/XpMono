...
namespace Fig
{
	...
	FigCode __cdecl initialize(__in HANDLE unmanaged_quit_event, __out FigInterfaces* interfaces, __out FigInformation* information);
	...
	FigCode __cdecl status(__in OperationId, __out ExecutionStatus* status, __out FigSpecificCode* specific_code);
